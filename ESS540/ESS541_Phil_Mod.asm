...
ROMSBEG EQU    $F000        ; EXTENSION ROM START
FLXLD   EQU    $F000        ; FLEX LOAD ROUTINE ADDRESS
...
STACK   EQU    *            ; START OF INITIAL STACK
        ORG    $F036
COON    EQU    *            ; $F036 --> VIA, ACIA... INIT 
        ORG    $F03C
CODTA   EQU    *            ; $F03C --> CHAR DISPLAY ROUTINE
...
INITVT  FDB    CMDTBL-*     ; DEFAULT FIRST COMMAND TABLE
        ...
        FDB    COON-*       ; DEFAULT COON -> $F7DA => $F036
